...
public interface VisitorRepository extends JpaRepository<Visitor, Integer> {
    @Query(value ="select people_id as id, people_name as name, people_gender as gender, people_age as age, people_email as email, people_phone as phone, DATE_FORMAT( visit_date, '%Y-%m-%d' ) as date, visit_duration as duration \n" +
