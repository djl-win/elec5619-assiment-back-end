...
CREATE TABLE `tb_comment`  (
  ...
  `comment_visitorId` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`comment_id`) USING BTREE,
  INDEX `FK_comment_visitorId`(`comment_visitorId`) USING BTREE,
...
CREATE TABLE `tb_venue`  (
  ...
  `venue_currentFlow` int(11) NULL DEFAULT NULL COMMENT '场馆当前人数，可通过查询visit表获取。或者触发器',
